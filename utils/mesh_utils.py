...
class GaussianExtractor(object):
    ...
    @torch.no_grad()
    def reconstruction(self, viewpoint_stack) -> Generator:
        """
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            yield rgb, alpha, depth, normal, depth_normal
    ...
    @torch.no_grad()
    def extract_mesh_bounded(self, rec: Generator, voxel_size=0.004, sdf_trunc=0.02, depth_trunc=3, mask_backgrond=True):
        """
        ...
        for i, (rgb, alpha, depth, normal, depth_normal) in enumerate(rec):
            cam_o3d = to_cam_open3d(self.viewpoint_stack)[i]
